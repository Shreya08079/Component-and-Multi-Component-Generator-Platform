    ...
    <>
      ...
      <main style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', background: '#F5F7FA' }}>
        <div style={{ background: '#fff', borderRadius: 12, boxShadow: '0 2px 16px #1e2a4420', padding: 40, minWidth: 340, maxWidth: '90vw', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <h2 style={{ color: '#1E2A44', fontWeight: 800, fontSize: 30, marginBottom: 8 }}>Login to CodeCraft</h2>
          <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', width: 260, gap: 12, marginTop: 12 }}>
            <input
              type="email"
              placeholder="Email"
              value={email}
            ...
            <button type="submit" style={{ background: '#4A90E2', color: '#fff', padding: 12, borderRadius: 7, fontWeight: 700, fontSize: 18, marginTop: 8, border: 'none', boxShadow: '0 1px 4px #4a90e220' }}>Log In</button>
          ...
          <p style={{ marginTop: 18, fontSize: 15 }}>
            Don't have an account? <a href="/signup" style={{ color: '#4A90E2', fontWeight: 600 }}>Sign up</a>
          </p>
